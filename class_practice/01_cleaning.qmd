...
The data is contained within the file `data/global-organ-donation_2018.csv`. The questionnaire on which the data is based is contained within the [Questionnaire.pdf](https://github.com/Yu-Group/vds-book-supplementary/tree/main/R/organ_donations/data/data_documentation) PDF file. If you plan on working with this data, we highly recommend that you glance through this document. 
...
```{r}
organs_original <- read_csv("data/global-organ-donation_2018.csv", col_types = list(`Utilized DBD` = col_number(),
